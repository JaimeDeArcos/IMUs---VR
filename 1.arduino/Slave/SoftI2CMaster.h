 ...
 *  ORIGEN: https://github.com/felias-fogg/SoftI2CMaster/blob/master/SoftI2CMaster.h
 *  
 *  Libreria MUY rapida y Muy ligera para comunicacion I2C Software
 *  escrita en ensamblador. Basada en Peter Fleury's I2C software
 *  library: http://homepage.hispeed.ch/peterfleury/avr-software.html
 *
 *  Esta lireria es software libre y se puede distribuir o modificar 
 *  bajo los terminos de GNU General Public License.
 *
/*  [DEFINIR] Para usar esta libreria se necesitan definir los sig Pines:
 ...
 * - I2C_FASTMODE = 1     :Significa que el bus acepta velocidades de 400 kHz
 * - I2C_SLOWMODE = 1     :Significa que el bus acepta velocidades HASTA 25 kHz 
 * - I2C_NOINTERRUPT = 1  :Para prohubi las interrupciones mientras se comunica
 *                         Puede ser util si se utiliza para SMbus devices, que 
 *                         tienen timeouts.   
 * - I2C_TIMEOUT = 0..10000 ms de timeout en caso de de que se bloquee el bus. 0
 *                         significa que no hay timeout
 *******************************************************************************/
...
// Funcion Inicializacion. Necesita ser llamada al principio.
// Devuelve False si SDA o SCL esta low, (lo que significa que el bus esta 
// bloqueado o que el bus no tiene las resistencias pullup.
